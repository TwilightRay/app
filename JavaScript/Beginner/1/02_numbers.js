...
console.log('abs', Math.abs(-42))
console.log('max', Math.max(42, 12, 23, 1, 422))
console.log('min', Math.min(42, 12, 23, 1, 422))
console.log('floor', Math.floor(4.9)) // округдение в меньшую сторону
console.log('ceil', Math.ceil(4.9)) // округление к большему
console.log('round', Math.round(4.9)) // округление к близжайшему целому
console.log('trunc', Math.trunc(4.9)) // удаляет дробные знаки
console.log('sin', Math.sin(1/3))
